...
# SERRF
amide_serrf <- bc_serrf(omicsData = pmart_amideFilt,sampletype_cname = "group",test_val = "QC",group_cname = "group")
...
# QC-RFSC
pmart_amideFilt_abundance <- pmartR::edata_transform(pmart_amideFilt,"abundance")
amide_qcrfsc <- bc_qcrfsc(omicsData = pmart_amideFilt_abundance,qc_cname = "group",qc_val = "QC",
                          order_cname = "Injection_order",ntree = 500, keep_qc = FALSE,group_cname = "group")
amide_qcrfsc <- pmartR::edata_transform(amide_qcrfsc,"log2")
```
